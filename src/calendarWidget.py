...
class Calendar:
    def __init__(self, parent, values, dateLbl):
        self.values = values
        self.parent = parent
        ...
        self.setup(self.year, self.month, dateLbl)
    ...
    def selection(self, day, name, dateLbl):
        ...
        self.values = datetime.date(self.year, self.month, day)
        dateLbl.configure(text=self.values.strftime("%x"))

        self.clear()
        self.setup(self.year, self.month, dateLbl)

    def setup(self, y, m, dateLbl):
            ...
            for d, day in enumerate(week):
                if day:
                    ...
                    b = tk.Button(self.parent, width=1, text=day,
                                  command=lambda day=day: self.selection(day, calendar.day_name[(day - 1) % 7], dateLbl))
                    self.wid.append(b)
